		...
		<>
			...
			<div className="flex justify-center w-full min-h-screen text-slate-300">
				...
				<main className="w-8/12 p-8 overflow-auto bg-[#0d0d0d]">
					...
					>
						This is my personal Autohotkey script which I install on
						every new OS or computer I work on, it eliminates the
						need to always type out your username and password which
					...
					<div className="my-8">
						...
						<ol className="list-decimal ml-6">
							...
							<li>
								Choose the appropriate installer based on your
								operating system (Windows 32-bit or 64-bit).
							</li>
							<li>
								Run the installer and follow the on-screen
								instructions to install AutoHotkey.
							</li>
						</ol>
					</div>
					...
					<div className="my-8">
						...
						<ol className="list-decimal ml-6">
							<li>
								Open any text editor such as Notepad or any code
								editor of your choice.
							</li>
							<li>
								Start a new file and save it with a{' '}
								<code>.ahk</code> extension. For example,{' '}
								<code>myscript.ahk</code>.
							</li>
						</ol>
					</div>
					...
					<div className="my-8">
						...
						<p>
							Inside the <code>.ahk</code> file, you can write
							your AutoHotkey script using the AutoHotkey
							scripting language. Here's an example script that
							maps the Ctrl+Alt+Q key combination to open a
							specific folder:
						</p>
						<Code
							code={`autohotkey
...
return`}
					...
					<div className="my-8">
						...
						<p>
							Save the <code>.ahk</code> script file in a location
							of your choice. It's recommended to save it in a
							folder where you can easily locate it later.
						</p>
					</div>
					...
					<div className="my-8">
						...
						<p>
							To run the script, simply double-click on the{' '}
							<code>.ahk</code> file. The AutoHotkey program will
							launch, and your script will be active. You can now
							use the hotkeys or triggers defined in your script.
						</p>
					</div>
					...
					<div className="my-8">
						...
						<ol className="list-decimal ml-6">
							...
							<li>
								Type <code>shell:startup</code> and click "OK"
								to open the startup folder.
							</li>
							<li>
								Copy the <code>.ahk</code> script file and paste
								it into the startup folder.
							</li>
							<li>
								The script will now run automatically every time
