...
export default function Home() {
	return (
		<div className=" md:flex w-[284px] md:shrink-0  bg-[#000] p-6 top-[121px] h-[calc(100vh-121px)] md:justify-start flex-col">
			{allPosts.map((post) => (
				<article className="" key={post._id}>
					<Link href={post.slug}>
						<h3 className="mb-[4px] px-2 text-lg font-medium text-white">
							{post.title}
						</h3>
					</Link>
