...
export default function page() {
    return (
        <div className="bg-offblack text-offwhite h-screen w-screen">
            <div className="container-xl mx-auto">
                <div className="text-wrapper p-20">
                    <h1 className="text-7xl font-bold">
                        Hey, I'm remco<span className="text-themegreen">.</span>
                    </h1>
                    <h2 className="font-semibold text-3xl pt-3">
                        I'm a <span className="text-themegreen">front-end developer</span>
                    </h2>
                    ...
                    >
                        <span className="w-48 h-48 rounded rotate-[-40deg] bg-themegreen absolute bottom-0 left-0 -translate-x-full ease-out duration-500 transition-all translate-y-full mb-9 ml-9 group-hover:ml-0 group-hover:mb-32 group-hover:translate-x-0"></span>
