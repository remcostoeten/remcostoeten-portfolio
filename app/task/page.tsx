...
import { getAuth, browserLocalPersistence, browserSessionPersistence, setPersistence, createUserWithEmailAndPassword } from '@firebase/auth';
...
export default function Index() {
    ...
    const signInUser = async (email?: string, password?: string, rememberMe?: boolean) => {
        if (!email || !password) {
        ...
        try {
            ...
            console.error(error);
            toast.error('Something went wrong, probably a typo or already got an account? If this keeps happening contact the admin.');
        }
    };
    ...
    return (
        <>
            <div className="todo bg-gray-100 h-screen w-screen ">
                            ...
                            <div className="not-authorized flex items-center ">
                                <div className="not-authorized__inner text-black p-6">
                                    ...
                                    <p className="text-black text-sm">
                                        You should be logged in in order to use the task/to-do app.<br></br> You obviously don't want another user to edit your tasks, do you?
                                    </p>
