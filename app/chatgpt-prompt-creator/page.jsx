...
export default function Page() {
    ...
    const generateMessage = (text2, text1, customText, selectedTools) => {
        const tools = selectedTools.join(', ');
        const message = `Act as a ${text1} which has all the knowledge regarding ${text2}. I want you to build a feature with ${tools} ${customText}${includeUseClient ? "\n'use client';" : ''}`;
        setGeneratedMessage(message);
    };
                    ...
                    <form onSubmit={handleGenerateMessage}>
                        <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div className="flex flex-col">
                                ...
                                <select id="text1" value={selectedText1} onChange={handleText1Change} className="px-2 py-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ...
                            <div className="flex flex-col">
                                ...
                                <select id="text2" value={selectedText2} onChange={handleText2Change} className="px-2 py-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div className="flex items-center">
                            <input id="includeUseClient" type="checkbox" className="mt-2 mb-2" checked={includeUseClient} onChange={handleIncludeUseClientChange} />
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="mt-2">
                                ...
                                <input type="text" onChange={handleToolSelection} className="px-2 py-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" />
                            </div>
                        </div>
                        ...
                        {generatedMessage && (
                            <div className="mt-4 text-white flex flex-col font-medium">
                                ...
                                <button className="w-4 mt-2 px-4 py-2 text-white rounded-md focus:outline-none" onClick={handleCopyToClipboard}>
                                    Copy
                                </button>
                            </div>
                        )}
