        ...
        <>
            ...
            <div className="hero__left p-10 md:p-20 bg-themeblue h-screen theme-text grid items-center fixed md:w-1/2 justify-center content-between pt-28 md:pt-0 border-t-1 z-10">
                ...
                <div className="self-end signature theme-gray font-semibold text-base">
                    <p>
                        Find me on{' '}
                        <a className="text-white underline" href="https://github.com/remcostoeten" target="_blank" rel="noopener noreferrer">
                            Github
                        </a>{' '}
                        &{' '}
                        ...
                        <br />
                        or connect on`{' '}
                        <a className="text-white underline" href="https://nl.linkedin.com/in/remco-stoeten" target="_blank" rel="noopener noreferrer">
                            LinkedIn
                        </a>
                        <br />
                        Design iteration π(
