...
import { getAuth, createUserWithEmailAndPassword, setPersistence, browserSessionPersistence, browserLocalPersistence, updateProfile } from 'firebase/auth';
            ...
            <div className="modal">
                <div>
                    {registered && (
                        <div className="confetti-container">
                            <Confetti width={800} height={600} numberOfPieces={200} recycle={fadeOut} />
                        </div>
                    )}
                </div>
                <div className="modal__inner">
                    ...
                    <form className="modal__register" onSubmit={handleSignup}>
                        <motion.div className="modal__close" onClick={onClose} whileHover={{ scale: 1.05 }}>
                            <CloseIcon />
                        </motion.div>
