...
export default function AlertMessage({ id, type, message }) {
	...
	return (
		<div
			id={id}
			className={` z-50 flex align-middle items-center absolute bottom-5 left-0 right-0 mx-auto text-cente w-350px   p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-950 ${
				type === 'success'
					? 'border-green-500'
					: type === 'danger'
					? 'border-red-500'
