...
interface Props {
    isOpen: boolean;
    onClose: () => void;
    onSubmit: (title: string, description: string, category: string, taskId?: string) => void;
    editedTask: Task | null;
}

const TaskModal: React.FC<Props> = ({ isOpen, onClose, onSubmit, editedTask }) => {
            ...
            <div className="fixed inset-0 flex items-center justify-center">
                <div className="bg-zinc-100 rounded-md p-6 max-w-md w-full mx-auto">
                    <Dialog.Title className="text-xl font-semibold flex justify-between items-center">
                        ...
                        <button onClick={onClose} aria-label="close" className="focus:outline-none">
                            <CloseIcon />
                        </button>
                    </Dialog.Title>
                    <div className="mt-4">
