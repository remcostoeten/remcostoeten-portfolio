...
export default function Logo() {
    ...
    const colorClass = scrollPos > 596 ? 'theme-fill--alternative' : 'theme-fill';
    useEffect(() => {
        const onScroll = () => {
    ...
    <>
        ...
        <Link href="/">
            <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" x={0} y={0} className={'header__logo  ' + colorClass} style={{ enableBackground: 'new 0 0 209.8 46' }}>
                <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" id="Laag_1" width="836" height={184} x={0} y={0} style={{ enableBackground: 'new 0 0 209.8 46' }}>
                    <path
