...
export default function SidebarNav() {
	const liClass =
		'block text-gray-500 hover:text-gray-600 leading-[1.6] mb-2';
				...
				<div className="fixed left-sidebar">
					<div className="pt-5 mt-px p-0">
						<div className="mt-2">
							...
							<Link
								className={liClass}
								href="/docs/autohotkey-script"
							>
								<h3 className=" block cursor-pointer text-gray-500 hover:text-gray-600 leading-[1.6]">
									Autohotkey script
								</h3>
							</Link>
							<Link className={liClass} href="/powershell-config">
